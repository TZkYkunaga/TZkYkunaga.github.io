...
export const siteConfig: SiteConfig = {
	title: "Long's blog",
	subtitle: "Chào mừng trai xinh, gái đẹp đến với blog của Long Ngon Zai nha !",
	...
	banner: {
		enable: true,
		src: "assets/images/bloodmoon.gif", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
